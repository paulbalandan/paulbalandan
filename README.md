...
- **[NexusPHP/cs-config](https://github.com/NexusPHP/cs-config)** ([v3.24.2](https://github.com/NexusPHP/cs-config/releases/tag/v3.24.2), *2 days ago*) - :factory: A factory for custom rulesets for PHP CS Fixer.
...
- **[Implement Nexus Collection](https://github.com/NexusPHP/framework/pull/3)** on [NexusPHP/framework](https://github.com/NexusPHP/framework) (*2 days ago*)
