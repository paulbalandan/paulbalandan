...
- **[codeigniter4/shield](https://github.com/codeigniter4/shield)** ([v1.0.2](https://github.com/codeigniter4/shield/releases/tag/v1.0.2), *6 days ago*) - Authentication and Authorization for CodeIgniter 4
- **[larastan/larastan](https://github.com/larastan/larastan)** ([v2.9.2](https://github.com/larastan/larastan/releases/tag/v2.9.2), *3 weeks ago*) - ⚗️ Adds code analysis to Laravel improving developer productivity and code quality.
...
- **[NexusPHP/cs-config](https://github.com/NexusPHP/cs-config)** ([v3.22.0](https://github.com/NexusPHP/cs-config/releases/tag/v3.22.0), *4 weeks ago*) - :factory: A factory for custom rulesets for PHP CS Fixer.
- **[codeigniter4/CodeIgniter4](https://github.com/codeigniter4/CodeIgniter4)** ([v4.4.6](https://github.com/codeigniter4/CodeIgniter4/releases/tag/v4.4.6), *4 weeks ago*) - Open Source PHP Framework (originally from EllisLab)
- **[codeigniter4/devkit](https://github.com/codeigniter4/devkit)** ([v1.2.1](https://github.com/codeigniter4/devkit/releases/tag/v1.2.1), *1 month ago*) - Development toolkit for CodeIgniter libraries and projects
...
- **[style: enable `phpdoc_array_type`](https://github.com/codeigniter4/CodeIgniter4/pull/8580)** on [codeigniter4/CodeIgniter4](https://github.com/codeigniter4/CodeIgniter4) (*4 weeks ago*)
