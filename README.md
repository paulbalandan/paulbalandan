...
- **[kubawerlos/php-cs-fixer-custom-fixers](https://github.com/kubawerlos/php-cs-fixer-custom-fixers)** ([v3.34.0](https://github.com/kubawerlos/php-cs-fixer-custom-fixers/releases/tag/v3.34.0), *1 day ago*) - A set of custom fixers for PHP CS Fixer
- **[phpstan/phpstan](https://github.com/phpstan/phpstan)** ([2.1.28](https://github.com/phpstan/phpstan/releases/tag/2.1.28), *3 days ago*) - PHP Static Analysis Tool - discover bugs in your code without running it!
