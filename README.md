...
- **[larastan/larastan](https://github.com/larastan/larastan)** ([v2.9.2](https://github.com/larastan/larastan/releases/tag/v2.9.2), *2 days ago*) - ⚗️ Adds code analysis to Laravel improving developer productivity and code quality.
- **[PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer)** ([v3.51.0](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.51.0), *4 days ago*) - A tool to automatically fix PHP Coding Standards issues
