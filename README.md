...
- **[infection/infection](https://github.com/infection/infection)** ([0.34.0](https://github.com/infection/infection/releases/tag/0.34.0), *2 days ago*) - PHP Mutation Testing library
- **[PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer)** ([v3.95.11](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.95.11), *5 days ago*) - A tool to automatically fix PHP Coding Standards issues
...
- **[refactor: replace type `mixed` with more specific types](https://github.com/codeigniter4/CodeIgniter4/pull/10345)** on [codeigniter4/CodeIgniter4](https://github.com/codeigniter4/CodeIgniter4) (*1 day ago*)
