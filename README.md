...
- **[phpstan/phpstan](https://github.com/phpstan/phpstan)** ([2.1.7](https://github.com/phpstan/phpstan/releases/tag/2.1.7), *today*) - PHP Static Analysis Tool - discover bugs in your code without running it!
