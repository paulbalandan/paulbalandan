...
- **[phpstan/phpstan](https://github.com/phpstan/phpstan)** ([2.1.26](https://github.com/phpstan/phpstan/releases/tag/2.1.26), *1 day ago*) - PHP Static Analysis Tool - discover bugs in your code without running it!
- **[kubawerlos/php-cs-fixer-custom-fixers](https://github.com/kubawerlos/php-cs-fixer-custom-fixers)** ([v3.33.0](https://github.com/kubawerlos/php-cs-fixer-custom-fixers/releases/tag/v3.33.0), *6 days ago*) - A set of custom fixers for PHP CS Fixer
