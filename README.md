...
- **[NexusPHP/cs-config](https://github.com/NexusPHP/cs-config)** ([v3.20.0](https://github.com/NexusPHP/cs-config/releases/tag/v3.20.0), *today*) - :factory: A factory for custom rulesets for PHP CS Fixer.
