...
- **[PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer)** ([v3.82.2](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.82.2), *today*) - A tool to automatically fix PHP Coding Standards issues
- **[NexusPHP/cs-config](https://github.com/NexusPHP/cs-config)** ([v3.26.1](https://github.com/NexusPHP/cs-config/releases/tag/v3.26.1), *today*) - :factory: A factory for custom rulesets for PHP CS Fixer.
