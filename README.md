...
- **[NexusPHP/no-merge-commits](https://github.com/NexusPHP/no-merge-commits)** ([v2.2.0](https://github.com/NexusPHP/no-merge-commits/releases/tag/v2.2.0), *4 days ago*) - Prevent merge commits in pull requests.
