...
- **[larastan/larastan](https://github.com/larastan/larastan)** ([v2.9.2](https://github.com/larastan/larastan/releases/tag/v2.9.2), *1 day ago*) - ⚗️ Adds code analysis to Laravel improving developer productivity and code quality.
- **[PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer)** ([v3.51.0](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.51.0), *3 days ago*) - A tool to automatically fix PHP Coding Standards issues
- **[CodeIgniter/coding-standard](https://github.com/CodeIgniter/coding-standard)** ([v1.7.14](https://github.com/CodeIgniter/coding-standard/releases/tag/v1.7.14), *6 days ago*) - Official Coding Standards for CodeIgniter
...
- **[codeigniter4/CodeIgniter4](https://github.com/codeigniter4/CodeIgniter4)** ([v4.4.6](https://github.com/codeigniter4/CodeIgniter4/releases/tag/v4.4.6), *1 week ago*) - Open Source PHP Framework (originally from EllisLab)
