...
- **[laravel/framework](https://github.com/laravel/framework)** ([v9.24.0](https://github.com/laravel/framework/releases/tag/v9.24.0), *2 days ago*) - The Laravel Framework.
- **[codeigniter4/translations](https://github.com/codeigniter4/translations)** ([v4.2.2](https://github.com/codeigniter4/translations/releases/tag/v4.2.2), *4 days ago*) - System message translations for CodeIgniter4
- **[codeigniter4/CodeIgniter4](https://github.com/codeigniter4/CodeIgniter4)** ([v4.2.3](https://github.com/codeigniter4/CodeIgniter4/releases/tag/v4.2.3), *4 days ago*) - Open Source PHP Framework (originally from EllisLab)
...
- **[[9.x] Allow using static closures as callable for macros](https://github.com/laravel/framework/pull/43589)** on [laravel/framework](https://github.com/laravel/framework) (*3 days ago*)
