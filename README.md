...
- **[PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer)** ([v3.22.0](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.22.0), *today*) - A tool to automatically fix PHP Coding Standards issues
- **[CodeIgniter/coding-standard](https://github.com/CodeIgniter/coding-standard)** ([v1.7.5](https://github.com/CodeIgniter/coding-standard/releases/tag/v1.7.5), *1 day ago*) - Official Coding Standards for CodeIgniter
- **[NexusPHP/cs-config](https://github.com/NexusPHP/cs-config)** ([v3.13.0](https://github.com/NexusPHP/cs-config/releases/tag/v3.13.0), *1 day ago*) - :factory: A factory for custom rulesets for PHP CS Fixer.
...
- **[codeigniter4/CodeIgniter4](https://github.com/codeigniter4/CodeIgniter4)** ([v4.3.6](https://github.com/codeigniter4/CodeIgniter4/releases/tag/v4.3.6), *4 weeks ago*) - Open Source PHP Framework (originally from EllisLab)
...
- **[Update docs for `DOMNode::lookupNamespaceURI`](https://github.com/php/doc-en/pull/2573)** on [php/doc-en](https://github.com/php/doc-en) (*5 days ago*)
- **[Parameter and return of `DOMNode::lookupNamespaceURI` are both nullable](https://github.com/JetBrains/phpstorm-stubs/pull/1556)** on [JetBrains/phpstorm-stubs](https://github.com/JetBrains/phpstorm-stubs) (*5 days ago*)
- **[Fix signature of `DOMNode::lookupNamespaceURI`](https://github.com/phpstan/phpstan-src/pull/2527)** on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (*5 days ago*)
- **[More precise return type for trigger_error](https://github.com/phpstan/phpstan-src/pull/2526)** on [phpstan/phpstan-src](https://github.com/phpstan/phpstan-src) (*6 days ago*)
...
- **[chore: add no-merge-commits.yml](https://github.com/codeigniter4/shield/pull/764)** on [codeigniter4/shield](https://github.com/codeigniter4/shield) (*1 week ago*)
- **[Fix generics signature of `config()` and `model()`](https://github.com/codeigniter4/CodeIgniter4/pull/7660)** on [codeigniter4/CodeIgniter4](https://github.com/codeigniter4/CodeIgniter4) (*1 week ago*)
